"""
Analysis of precision with which a binary can be characterized.  The model being 
tested has two symmetric Gaussians with 20 uas FWHMs and includes station gains 
with a 10% amplitude uncertainties.  Two figures are generated:

1. A triangle plot of all parameters for a default set of fluxes and orientation.
2. A plot of the separation uncertatinty as a function of flux ratio for fixed total flux.
...
if __name__ == "__main__" :
    ...
    ff.plot_triangle_forecast(obslist,p,labels=labels,axis_location=[0.1,0.1,0.88,0.88])
